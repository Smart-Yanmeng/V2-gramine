...
from layer1_node import LAYER1_Node
...
def instantiate_node(i, N, p, t, bft_from_server: Callable, bft_to_client_SERVER: Callable, ip_list):
	bft = LAYER1_Node(i, N, p, t, bft_from_server, bft_to_client_SERVER, ip_list)
	return bft
...
if __name__ == '__main__':
	...
	try:
		...
		netServer = NetworkServer(my_address_SERVER[1], my_address_SERVER[0], i, addresses_SERVER, server_to_bft)#server.put
