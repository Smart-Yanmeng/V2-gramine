...
from server_node import SERVERBFTNode
...
def instantiate_node(i, N, p, t, bft_from_server: Callable, bft_to_client_SERVER: Callable, ip_lis, server_bft_mpq):
    bft = SERVERBFTNode(i, N, p, t, bft_from_server, bft_to_client_SERVER, ip_list, server_bft_mpq)
    return bft
...
if __name__ == '__main__':
    ...
    try:
        ...
        netClient = NetworkClient(my_address_SERVER[1], my_address_SERVER[0], i, addresses_SERVER,
                                  client_from_bft_SERVER)
        bft = instantiate_node(i, N, p, t, bft_from_server, bft_to_client_SERVER, ip_list, server_bft_mpq)
